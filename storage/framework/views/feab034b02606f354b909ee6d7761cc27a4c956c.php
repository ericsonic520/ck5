...
<div class="container bg-white p-4 shadow-sm rounded">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2>修改個人履歷</h2>
        <a href="/present/manage?page=<?php echo e($page); ?>" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> 返回上一頁</a>
    </div>
    ...
    <form id="resumeForm" enctype="multipart/form-data">
        ...
        <div class="collapse show mb-5" id="basicInfoSection">
            <div class="row pt-2">
                ...
                <div class="col-md-3 mb-4 avatar-upload-box border-right">
                    ...
                    <div class="preview-container">
                        ...
                        <span class="avatar-placeholder-text" style="<?php echo e(asset($presents[0]->resume_picme) ? 'display: none;' : ''); ?>">尚未上傳</span>
                        
                        <img class="avatar-image-preview" 
                            src="<?php echo e(asset($presents[0]->resume_picme) ? asset($presents[0]->resume_picme) : ''); ?>" 
                            alt="預覽圖" 
                            style="<?php echo e(asset($presents[0]->resume_picme) ? 'display: block;' : 'display: none;'); ?>">
                    </div>
                    ...
                    <label class="btn-select-file" style="cursor: pointer; display: block; text-align: center; margin-top: 10px;">
                        ...
                        data-init-src="<?php echo e($presents[0]->resume_picme ? asset($presents[0]->resume_picme) : ''); ?>" 
                    data-init-name="<?php echo e($path ?? '未選擇任何檔案'); ?>" accept="image/*" data-rule="required_avatar" style="font-size: 12px;">
                ...
                <div class="col-md-9">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="resume_name" class="form-control" value="<?php echo e(old('resume_name', $presents[0]->resume_name)); ?>" data-rule="required">
                            <div class="error-msg">請輸入履歷名稱</div>
                        </div>
                        <div class="form-group col-md-6">
                            <label>姓名 <span class="text-danger">*</span></label>
                            <input type="text" name="name" class="form-control" value="<?php echo e(old('resume_nickname', $presents[0]->resume_nickname)); ?>" data-rule="required">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <select name="gender" class="form-control" data-rule="required">
                                ...
                                <?php $__currentLoopData = $presents_sixes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $presents_six): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($presents_six->resume_six_id); ?>" <?php if(old('$presents_six->resume_six_id', $presents_six->resume_six_id) == $presents[0]->resume_sex ): ?> selected <?php endif; ?> ><?php echo e($presents_six->resume_sixname); ?></option>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" name="age" class="form-control" value="<?php echo e(old('resume_age', $presents[0]->resume_age)); ?>" data-rule="age">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select name="marriage" class="form-control" data-rule="required">
                                <option value="">請選擇</option>
                                <?php $__currentLoopData = $presents_marries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $presents_marry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($presents_marry->resume_marry_id); ?>" <?php if(old('$presents_marry->resume_marry_id', $presents_marry->resume_marry_id) == $presents[0]->resume_marry ): ?> selected <?php endif; ?> ><?php echo e($presents_marry->resume_marry_name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
            ...
            <div class="form-row mt-3">
                <div class="form-group col-md-4">
                    ...
                    <input type="text" name="school" class="form-control" value="<?php echo e(old('resume_education', $presents[0]->resume_education)); ?>" data-rule="required">
                    <div class="error-msg">請輸入畢業學校</div>
                </div>
                <div class="form-group col-md-4">
                    <label>手機號碼 <span class="text-danger">*</span></label>
                    <input type="text" name="phone" class="form-control" value="<?php echo e(old('resume_cellphone', $presents[0]->resume_cellphone)); ?>" data-rule="phone" placeholder="例如: 0912345678">
                    <div class="error-msg">請輸入正確的手機號碼格式 (台灣手機 10 碼)</div>
                </div>
                <div class="form-group col-md-4">
                    <label>電子信箱 <span class="text-danger">*</span></label>
                    <input type="text" name="email" class="form-control" value="<?php echo e(old('resume_email', $presents[0]->resume_email)); ?>" data-rule="email">
            ...
            <div class="form-group">
                ...
                <textarea name="summary" class="form-control" rows="3" data-rule="required"><?php echo e(old('resume_summary', $presents[0]->resume_summary)); ?></textarea>
                <div class="error-msg">請輸入個人簡介</div>
            </div>

            <div class="form-group">
                <label>求職簡介 <span class="text-danger">*</span></label>
                <textarea name="job_summary" class="form-control" rows="3" data-rule="required"><?php echo e(old('resume_introduction', $presents[0]->resume_introduction)); ?></textarea>
        ...
        <div class="mt-4">
            ...
            <div class="collapse show mb-5" id="experienceSection">
                <div id="experienceContainer" class="pt-2">
                    <?php $__currentLoopData = $resume_experience_decode; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $exp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="drag-item" data-type="experience">
                        <div class="d-flex align-items-center mb-2">
                            <span class="badge badge-info font-weight-bold item-id-badge">ID 經歷 <?php echo e($index+1); ?></span>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="exp_time[]" value="<?php echo e($exp['在職時間']); ?>" class="form-control" placeholder="如: 2024.01 - 2026.03" data-rule="required">
                                <div class="error-msg">請輸入在職時間</div>
                            </div>
                            <div class="form-group col-md-4">
                                <label>公司名稱 <span class="text-danger">*</span></label>
                                <input type="text" name="exp_company[]" value="<?php echo e($exp['公司']); ?>" class="form-control" data-rule="required">
                                <div class="error-msg">請輸入公司名稱</div>
                            </div>
                            <div class="form-group col-md-4">
                                <label>職稱 <span class="text-danger">*</span></label>
                                <input type="text" name="exp_title[]" value="<?php echo e($exp['職稱']); ?>" class="form-control" data-rule="required">
        ...
        <div class="mt-4">
            ...
            <div class="collapse show mb-5" id="skillSection">
                <div id="skillContainer" class="pt-2">
                    <?php $__currentLoopData = $resume_skill_decode; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="drag-item" data-type="skill">
                        <div class="d-flex align-items-center mb-2">
                            <span class="badge badge-success font-weight-bold item-id-badge">ID 技能 <?php echo e($index+1); ?></span>
                            <small class="text-muted ml-2"><i class="fas fa-arrows-alt-v"></i> 點擊此框內任意區域即可拖曳</small>
                        ...
                        <div class="form-row align-items-center">
                            <div class="form-group col-md-3">
                                ...
                                <select name="skill_category[]" class="form-control" data-rule="required">
                                    ...
                                    <?php $__currentLoopData = $presents_skill_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $presents_skill_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    
                                        <option value="<?php echo e($presents_skill_type->resume_skill_type_name); ?>" <?php if(old('$presents_skill_type->resume_skill_type_id', $presents_skill_type->resume_skill_type_id) == $skill['type'] ): ?>selected <?php endif; ?> >
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="skill_name[]" class="form-control" value="<?php echo e($skill['skill']); ?>" data-rule="required">
                            ...
                            <div class="form-group col-md-5">
                                ...
                                <div class="rating-stars d-flex align-items-center mt-2">
                                    ...
                                    <?php for($i = 1; $i <= 5; $i++): ?>
                                        ...
                                        <i class="far fa-star star-input <?php echo e($i <= $currentRating ? 'checked fas' : ''); ?>" data-value="<?php echo e($i); ?>"></i>
                                    <?php endfor; ?>
                                    <input type="hidden" name="skill_level[]" value="<?php echo e($skill['trained']); ?>" class="star-rating-val" data-rule="required_star">
                                </div>
        ...
        <div class="mt-4">
            ...
            <div class="collapse show mb-5" id="portfolioSection">
                <div id="portfolioContainer" class="pt-2">
                    <?php $__currentLoopData = $resume_sideproject_decode; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $sideproject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="drag-item" data-type="portfolio">
                        <div class="d-flex align-items-center mb-2">
                            <span class="badge badge-warning font-weight-bold item-id-badge">ID 作品 <?php echo e($index+1); ?></span>
                            <small class="text-muted ml-2"><i class="fas fa-arrows-alt-v"></i> 點擊此框內任意區域即可拖曳</small>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-4 upload-box border-right"
                                data-init-src="<?php echo e($sideproject['路徑'] ? asset($sideproject['路徑']) : ''); ?>" 
                                data-init-name="<?php echo e($sideproject['圖片名稱'] ?? '未選擇任何檔案'); ?>">
                                
                               
                                <label>作品縮圖 <span class="text-danger">*</span></label>
                                <div class="preview-container">
                                    
                                    <span class="placeholder-text" style="<?php echo e(asset($sideproject['路徑']) ? 'display: none;' : ''); ?>">尚未上傳</span>
                                    <label>作品縮圖 <span class="text-danger">*</span></label>
                                    <img class="image-preview" 
                                        src="<?php echo e(asset($sideproject['路徑']) ? asset($sideproject['路徑']) : ''); ?>" 
                                        alt="預覽圖" 
                                        style="<?php echo e(asset($sideproject['路徑']) ? 'display: block;' : 'display: none;'); ?>">
                                </div>
                                ...
                                <div class="filename-display text-muted text-center ">
                                    <?php echo e($portFolioPath ?? '未選擇任何檔案'); ?>
                            ...
                            <div class="col-md-9">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="portfolio_title[]" class="form-control" value="<?php echo e($sideproject['圖片名稱']); ?>" data-rule="required">
                                        <div class="error-msg">請輸入作品名稱</div>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>作品連結 <span class="text-danger">*</span></label>
                                        <input type="text" name="portfolio_link[]" class="form-control" placeholder="https://..." value="<?php echo e($sideproject['連結']); ?>" data-rule="url">
                                        <div class="error-msg">請輸入正確的網址格式</div>
                                    </div>
                                </div>
                                <div class="form-group mb-0">
                                    <label>作品說明 <span class="text-danger">*</span></label>
                                    <textarea name="portfolio_desc[]" class="form-control" rows="2" data-rule="required"><?php echo e($sideproject['說明']); ?></textarea>
            ...
            <div class="card p-4 shadow-sm" style="max-width: 400px;">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <input type="checkbox" id="statusCheckbox" name="resume_display" value="1" class="d-none" data-rule="required" 
                        data-id="<?php echo e($presents[0]->resume_id ?? 1); ?>" 
                        <?php echo e(($presents[0]->resume_display ?? 0) ? 'checked' : ''); ?> >

                    <!-- 自訂的「左右切換膠囊按鈕」 -->
                    <div id="btnSwitch" class="custom-switch-btn <?php echo e(($presents[0]->resume_display ?? 0) ? 'active' : ''); ?>">
        ...
        <div class="form-row">
            <div class="col-md-3 mb-2">
                <input type="hidden" name="resume_display" id="resume_display" value="<?php echo e($presents[0]->resume_display); ?>">
                <input type="hidden" name="resume_id" id="resume_id" value="<?php echo e($presents[0]->resume_id); ?>">
                <div href="/present/manage?page=<?php echo e($page); ?>" id="btnReback" class="btn btn-secondary btn-lg btn-block">返回上一頁</div>
            </div>
...
$(document).ready(function() {
    ...
    $('#btnSwitch').click(function() {
        ...
        //                 window.location.href = '/present/<?php echo e($presents[0]->resume_id); ?>/edit'; 
    ...
    $('#btnReback').click(function() {
        ...
        var targetPage = urlParams.get('page') || <?php echo e($page); ?>;
...
</html><?php /**PATH C:\Users\ericsonic520\Desktop\res\ck5\resources\views/present/resumeEdit.blade.php ENDPATH**/ ?>