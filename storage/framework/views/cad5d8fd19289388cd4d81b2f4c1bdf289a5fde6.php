        ...
        <div class="col-md-12">
            ...
            <div class="col-md-9" style="float:right;">
                ...
                <table class="table">
                    ...
                    <tr class="post_down"><td><?php echo e(substr($faq->post_time,0,-8)); ?></td><td class="des_lef"><a href="/news/<?php echo e($faq->post_id); ?>/faq" class="share_title" title="<?php echo e($faq->post_title); ?>"><?php echo e($faq->post_title); ?></a></td></tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <!-- <tr>
                        <td colspan="2">
                ...
                <div style="text-align:center">
                    <?php if($Faq->currentPage()-1 > 0): ?>
                    <a href="/news/share?page=1">&nbsp;&nbsp;第一頁&nbsp;&nbsp;</a>
                    <?php endif; ?>
                    <?php if($Faq->currentPage()-1 > 0): ?>
                    <a href="<?php echo e($Post->previousPageUrl()); ?>">&nbsp;&nbsp;上一頁&nbsp;&nbsp;</a>
                    <?php endif; ?>
                    <?php for($i=1;$i<=$total_pages;$i++): ?>
                        <?php if($i!=$Faq->currentPage()): ?>
                            <a href="/news/share?page=<?php echo e($i); ?>">&nbsp;&nbsp;<?php echo e($i); ?>&nbsp;&nbsp;</a>
                        <?php else: ?>
                            &nbsp;&nbsp;<?php echo e($i); ?>&nbsp;&nbsp;
                        <?php endif; ?>
                    <?php endfor; ?>
                    <?php if($Faq->currentPage()-1 >= 0 && $Faq->currentPage()!=$Faq->lastPage()): ?>
                    <a href="<?php echo e($Faq->nextPageUrl()); ?>">&nbsp;&nbsp;下一頁&nbsp;&nbsp;</a>
                    <?php endif; ?>
                    <?php if($Faq->hasMorePages() > 0): ?>
                    <a href="/news/share?page=<?php echo e($Faq->lastPage()); ?>">&nbsp;&nbsp;最後一頁&nbsp;&nbsp;</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('front.masterInside', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ericsonic520\Desktop\res\ck5\resources\views/front/showNewsFaq.blade.php ENDPATH**/ ?>