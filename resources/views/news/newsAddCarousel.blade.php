...
<div class="container">
	...
	<div class="card card-default">
        <div class="card-header">
          ...
          <!-- /.card-header -->
        <div class="card-body">
            <form action="{{'/news/addcarouseldeal'}}" method="post" enctype="multipart/form-data">
                {{-- CSRF 欄位 --}}
				{{ csrf_field() }}
                {{-- 隱藏方法欄位 --}}
                {{ method_field('PUT') }}
                <div class="container">
                    ...
                    <div class="form-group col-md-3">
                        <label for="carousel_image">輪播圖片:</label>
                        <input id="carousel_image" type="file" name="carousel_image" laceholder="輪播圖片" value="">
                    </div>
