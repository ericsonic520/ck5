...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
	...
	<div class='swiper-top'>
		<div>
			<div style="float:left">News&Notice 案例分享</div>
			<div style="float:right"><a href="{{url('/news/share')}}" style="color:#4fff00;text-decoration:none;">more</a></div>
		</div>
		<div class="swiper mySwiper">
			<div class="swiper-wrapper">
			@foreach($PostPaginate as $Post)
					<div class="swiper-slide">
						<div style="float:left">•<a style="color:black;text-decoration:none;" href="news/{{$Post->post_id}}/itm" title="{{$Post->post_title}}">{{ Illuminate\Support\Str::limit($Post->post_title, 50, '...') }}</a></div>
						<div style="float:right">{{substr($Post->post_time,0,-8)}}</div>	
					</div>
					@endforeach
			</div>
		</div>
