	...
	<div class="card card-default">
        ...
        <div class="card-body">
            ...
            <script>
                ...
                // 监听表单提交事件
                $('#packAndSubmit').submit(function(e){
                    // 1. 阻擋表單預設的刷新頁面行為
                    e.preventDefault();
                    ...
                    if(resume_introducation){
                        if( !resume_introducation_reg.test(resume_introducation) ){
                            $("#resume_introducation").focus();
                            invalid_introducation_feedback = "【簡介】格式不正確";
                            isFormValid = false;
                        }else{
                            $("#resume_introducation").focus();
                            invalid_introducation_feedback = "";
                            isFormValid = false;
                        }
                    }else{
                    ...
                    if (isFormValid) {
                        ...
                        const payload = { resume_name,resume_nickname,resume_education };
